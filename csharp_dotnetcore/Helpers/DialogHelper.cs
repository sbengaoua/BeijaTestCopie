...
namespace QnAMakerActiveLearningBot.Helpers
{
    ...
    public class DialogHelper
    {
        ...
        private async Task<DialogTurnResult> DisplayQnAResult(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            ...
            {
                var msg = "Je n'ai pas compris ce que vous vouliez dire. Je ne suis pas apte à répondre à cette question. Si cette question est une question de sécurité, veuillez envoyer la question à cette adresse : sbengaoua753@beijaflore.com";
