...
namespace QnAMakerActiveLearningBot
{
    ...
    public class QnAMakerActiveLearningBot : IBot
    {
        ...
        private const string WelcomeText = "Je suis Beijaflore security chatbot, je suis la pour répondre à toutes vos questions de sécurité, demandez moi quelque chose pour commencer le chat";
